    ...
    if (m.mentionedJid.includes(botNumber)) {
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "SOLO-LEVELING-MD 🥀",
            body: config.DESCRIPTION || "POWERED BY SOLO-LEVELING 🥶💦",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/8h21es.jpeg", // Static image URL
            sourceUrl: "https://wa.me/message/mdxclllclfrdxx",
